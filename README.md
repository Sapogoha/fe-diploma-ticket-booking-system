...
На данный момент (6.11) полностью реализованы внешний вид и основной функционал главной страницы, страниц выбора поездов и мест. Страница пассажиров в разработке.
