...
На данный момент (10.11) полностью реализованы внешний вид и основной функционал главной страницы, страниц выбора поездов, мест, пассажиров и метода платежа.
