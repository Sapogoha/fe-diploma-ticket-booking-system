...
На данный момент (14.11) полностью реализованы внешний вид и основной функционал главной страницы, страниц выбора поездов, мест, пассажиров, метода платежа и подтверждения заказа.
