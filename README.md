...
На данный момент (7.11) полностью реализованы внешний вид и основной функционал главной страницы, страниц выбора поездов, мест и пассажиров.

В первую очередь тестирую в хроме.
Главная на данный момент адаптирована для устройств с шириной экрана от 960px, страницы выбора поездов, мест и пассажиров - от 1152px, брейкпоинты выбирал на свое усмотрение, поскольку в макете этого нет.
