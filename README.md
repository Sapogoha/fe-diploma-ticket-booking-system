...
На данный момент (21.10) полностью реализованы внешний вид и основной функционал главной страницы, страниц выбора поездов и мест. Страница пассажиров в разработке.
