...
На данный момент (11.11) полностью реализованы внешний вид и основной функционал главной страницы, страниц выбора поездов, мест, пассажиров и метода платежа. Страница подтверждения заказа готова за исключением отправки запроса на сервер.
